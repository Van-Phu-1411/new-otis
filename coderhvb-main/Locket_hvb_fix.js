...
var hvb_entitlement = {
  ...
  product_identifier: "com.vuongducha.premium.yearly",
  expires_date: "2099-12-18T01:04:17Z" // Ngày hết hạn lâu dài
};
...
if (match) {
  ...
  let subscriptionKey = mapping[match][1] || "com.vuonducha.premium.yearly";

  obj.subscriber.subscriptions[subscriptionKey] = vuongducha;
  obj.subscriber.entitlements[entitlementKey] = hvb_entitlement;
} else {
  // Gán mặc định nếu không có khớp
  obj.subscriber.subscriptions["com.vuongducha.premium.yearly"] = vuongducha;
